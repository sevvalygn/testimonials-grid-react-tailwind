  ...
  return (
    <main className="min-h-screen bg-[hsl(214_17%_92%)] px-6 py-[71px] md:py-[164px]">
      <section className="mx-auto grid w-full max-w-[327px] gap-6 md:max-w-[1110px] md:grid-cols-4">
        <article className="relative overflow-hidden rounded-xl bg-[hsl(263_55%_52%)] p-8 text-white md:col-span-2">
  <img
    src={bgPattern}
    alt=""
    aria-hidden="true"
    className="absolute right-6 top-0 z-0 w-[104px] opacity-70"
  />
      ...
      I've successfully switched careers, working as a Software Engineer at a VR startup.
        ...
        <article className="rounded-xl bg-[hsl(217_19%_35%)] p-8 text-white">
          ...
          <p className="text-[13px] leading-[1.4] opacity-70">
            ...
            for a big company. This was one of the best investments Iaposve made in myself.
          </p>
        </article>
        ...
        <article className="rounded-xl bg-white p-8 text-[hsl(224_10%_45%)] md:col-start-4 md:row-span-2">
          ...
          <p className="mb-4 text-[20px] font-semibold leading-[1.35] text-[hsl(217_19%_35%)]">
            Such a life-changing experience. Highly recommended!
          </p>
          <p className="text-[13px] leading-[1.4]">
            Before joining the bootcamp, Iaposve never written a line of code. I needed some structure
            ...
            my learning to the next level in a way that no tutorial could ever have. In fact, Iaposve
